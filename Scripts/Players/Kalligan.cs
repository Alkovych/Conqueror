...
public class Kalligan : MonoBehaviour {
    ...
    public string playerAtack = "KalliganAttack";
    public string playerGetHit = "KalliganGetHit";
    public string playerDeth = "KalliganDeth";

    public int skill1 = 0;
    public int skill2 = 1;
    public int skill3 = 3;

    public Kalligan(int playerHP, int playerMaxHP, int playerIndex, int playerEnergy, int playerDamage, int playerDefence, int playerGold,
    ...
    public void KalliganFunctionSave()
    {
